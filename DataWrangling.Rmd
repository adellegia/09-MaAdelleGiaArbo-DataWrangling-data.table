...
To highlight what a data table is, we will create data tables in a multitude of methods and compare the results with a data frame. 
...
For a data table named DT, DT[i, j, by] translates to "Take DT, subset rows using **i**, then calculate **j** grouped by **by**".
...
Selecting columns is easier with data table as there is no requirement to insert the initial comma. 
...
The remaining examples shows the multitude of functions on how you can call specific values and vectors. 
...
Summarising data is more readable and easier to type as it takes fewer key strokes. 
