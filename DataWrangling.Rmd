...
It's worth noting that dtplyr allows you to write dplyr code that can be automatically translated to the equivalent data.table code. 
...
# Summarizing data
The basic arguments within brackets are NOT row and column numbers but rather "i", "j" and "by". Say you have a data table called DT. In words, DT[i, j, by] translates to "Take DT, subset rows using **i**, then calculate **j** grouped by **by**".
