...
A) Please create a new column(variable) called ‘mileage_type’ that has the value ‘high’ if mpg > 30. If mpg < 30, then the value should be 'low'. 
...
B) Please import the `mtcars_fun` dataset as a data table. Please name this data table `mt_fun'.
...
C) Please inner join the 'mtcars_fun' and 'mt' data tables as a new data table called 'mt_merge'.
...
D) Please convert the mpg variable into kilometres per litre. The formula for conversion is 1 mpg = 2.352 lkm.
